...
const Home = () => {
  ...
  const socialLinks = [
    { icon: <FaGithub />, href: "https://github.com/Priyadarshan-B/", color: "hover:text-green-600 dark:hover:text-green-400" },
    { icon: <FaLinkedin />, href: "https://www.linkedin.com/in/priyan1808", color: "hover:text-blue-500 dark:hover:text-blue-300" },
    { icon: <FaInstagram />, href: "https://www.instagram.com/_priyan_2004?igsh=N3V6anY5NjRsazAz", color: "hover:text-pink-500 dark:hover:text-pink-300" },
    { icon: <SiLeetcode />, href: "https://leetcode.com/u/priyan18824/", color: "hover:text-orange-500 dark:hover:text-orange-300" },
  ];
    ...
    <div className="flex flex-col md:flex-row items-center justify-center h-full w-full px-24 text-center md:text-left">
      <div className="mb-6 md:mb-0 md:w-1/2">
        <h1 className="text-4xl md:text-5xl font-semibold text-gray-900 dark:text-fontDark" data-aos="fade-right">
          ...
          <span className="txt font-medium text-indigo-600 dark:text-indigo-400">{currentWord}</span>
          
          <span className="blink text-indigo-600 dark:text-indigo-400 animate-blink">|</span>
        </h1>
        <p className="mt-4 text-lg text-gray-600 dark:text-smallFontDark" data-aos="fade-right">
          <span className="font-semibold text-2xl text-indigo-600 dark:text-indigo-400">MERN</span> stack developer and <span className="font-semibold text-indigo-600 dark:text-indigo-400 text-2xl">DevOps</span> enthusiast
        </p>
        ...
        <div className="mt-6 p-6 rounded-lg flex flex-no-wrap gap-4 justify-center" data-aos="fade-down">
